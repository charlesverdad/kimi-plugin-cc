...
argument-hint: "[--background|--wait] [--continue] [--model <model>] [--thinking] [what Kimi should investigate, solve, or continue]"
...
- Otherwise, before starting Kimi, check for a resumable task from this Claude session by running:
